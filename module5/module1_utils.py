"""
Utility functions for using module1's noise simulator in module5.

This module provides functions to add noise to text using module1's noise models.
"""
...
def create_noise_model(noise_type: str = "qwerty", noise_level: str = "moderate") -> CompositeNoiseModel:
    """
